      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar">
              <div class="container-xl">
                  <ul class="navbar-nav">
                      <li class="nav-item">
                          <a class="nav-link" href="{{ route('pages.dashboard') }}" wire:navigate>
                              <span
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="{{ route('pages.domains.index') }}" wire:navigate>
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="{{ route('pages.sites.index') }}" wire:navigate>
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="{{ route('pages.security.index') }}" wire:navigate>
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="{{ route('pages.udisk.index') }}" wire:navigate>
                      ...
                      <li class="nav-item">
                         <a class="nav-link" href="{{ route('pages.tquotas.index') }}" wire:navigate>
                              <span
                      ...
                      <li class="nav-item">
                                                  <a class="nav-link" href="{{ route('pages.ssl.index') }}" wire:navigate>
